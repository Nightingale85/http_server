...
public class LevelInfoHandler implements HttpHandler {
    ...
    public LevelInfoHandler(InfoService infoService) {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        switch (requestMethod){
            case METHOD_GET:
                final int levelId = getEntityId(httpExchange.getRequestURI().getPath(), LEVEL_INFO + "/");
                final List<ResultEntityId> resultEntityList = infoService.findTopLevelInfo(levelId);
